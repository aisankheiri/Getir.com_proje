...
const Kategoriler = ({ cartItems, setCartItems, categories, productItems }) => {
    ...
    <div className='row'>
      <div className='column left'>
        <div className='category'>
          ...
          {/* <div className='category-items'>
            <div>
              {categories.map((category) => (
                <div>
                  <button className='category-btn'><img src={category.image} alt='img' /><div className='textler'>{category.categoryName}</div>
          ...
          <Scrollbars style={{ width: 240, height: 550 }}>
            <div className='category-items'>
              <div>
                <button className='category-btn' onClick={toggleDropdown1}><img src={img1} alt='img1' /><div className='textler'>Yaza Özel</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen1 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown2}><img src={img2} alt='img2' /><div className='textler'>İndirimler</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen2 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown3}><img src={img3} alt='img3' /><div className='textler'>Su & içecek</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen3 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown4}><img src={img4} alt='img4' /><div className='textler'>Meyve & Sebze</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen4 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown5}><img src={img5} alt='img5' /><div className='textler'>Fırından</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen5 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown6}><img src={img6} alt='img6' /><div className='textler'>Temel Gıda</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen6 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown7}><img src={img7} alt='img7' /><div className='textler'>Atıştırmalık</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen7 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown8}><img src={img8} alt='img8' /><div className='textler'>Dondurma</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen8 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown9}><img src={img9} alt='img9' /><div className='textler'>Süt Ürünleri</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen9 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown10}><img src={img10} alt='img10' /><div className='textler'>Kahvaltılık</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen10 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown11}><img src={img11} alt='img11' /><div className='textler'>Yiyecek</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen11 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown12}><img src={img12} alt='img12' /><div className='textler'>Fit & Form</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen12 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown13}><img src={img13} alt='img13' /><div className='textler'>Kişisel Bakım</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen13 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown14}><img src={img14} alt='img14' /><div className='textler'>Ev Bakım</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen14 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown15}><img src={img15} alt='img15' /><div className='textler'>Ev & Yaşam</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen15 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown16}><img src={img16} alt='img16' /><div className='textler'>Teknoloji</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen16 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown17}><img src={img17} alt='img17' /><div className='textler'>Evcil Hayvan</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen17 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown18}><img src={img18} alt='img18' /><div className='textler'>Bebek</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen18 && (
                  <div>
              ...
              <div>
                <button className='category-btn' onClick={toggleDropdown19}><img src={img19} alt='img19' /><div className='textler'>Cinsel Sağlık</div>
                  <BsChevronDown className='down-icon' />
                </button>
                {isOpen19 && (
                  <div>
      ...
      <div className='column middle'>
        ...
        <Scrollbars style={{ width: 640, height: 550 }}>

          {(!isOpen1 && !isOpen2 && !isOpen3 && !isOpen4 && !isOpen5) && (
            <div className="Products-container">
              {productItems.map((productItem) => {
                if (productItem.group === "yazaozel") {
                  return (
                    <ProductItem
                      key={productItem.id}
          ...
          {isOpen2 && (
            <div className="Products-container">
              {productItems.map((productItem) => {
                if (productItem.altgroup === "dondurma") {
                  return (
                    <ProductItem
                      key={productItem.id}
                      productItems={productItem}
          ...
          {isOpen3 && (
            <div className="Products-container">
              {productItems.map((productItem) => {
                if (productItem.altgroup === "suVeicecek") {
                  return (
                    <ProductItem
                      key={productItem.id}
                      productItems={productItem}
          ...
          {isOpen4 && (
            <div className="Products-container">
              {productItems.map((productItem) => {
                if (productItem.altgroup === "meyveSevze") {
                  return (
                    <ProductItem
                      key={productItem.id}
                      productItems={productItem}
          ...
          {isOpen5 && (
            <div className="Products-container">
              {productItems.map((productItem) => {
                if (productItem.altgroup === "fırından") {
                  return (
                    <ProductItem
                      key={productItem.id}
                      productItems={productItem}
